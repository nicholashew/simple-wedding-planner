...
(function () {
  ...
  const STRINGS = {
    ...
    zh: {
      ...
      cardLinkGame:     '開始',
      menuFooterNote:   '所有菜式均為本次宴席精心準備，部分食材視季節供應而定。',
      menuFooterWish:   '祝各位用餐愉快，賓至如歸！',
      menuPreviewBtn:     '查看宴席菜單',
      menuPreviewTitle:   '宴席菜單',
      menuPreviewCaption: '僅供參考，實際呈現或有所不同。',
      exploreMore:      '探索更多',
      navHome:          '主頁',
      navGallery:       '相簿',
      navVideo:         '影片',
