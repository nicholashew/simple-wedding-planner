...
(function () {
  ...
  function buildNav() {
    ...
    nav.innerHTML = `
      <a class="nav-brand" href="${resolveHref('index')}">🏠💒 Admin</a>
      <div class="nav-links">
        <a class="nav-link" href="${resolveHref('homestay')}">🏠 Homestay</a>
        <a class="nav-link" href="${resolveHref('wedding')}">💒 Wedding</a>
        <a class="nav-link" href="${resolveHref('find-table')}">🔍 Find Table</a>
        <a class="nav-link" href="/" target="_blank">🔗 Guest Site</a>
      </div>
